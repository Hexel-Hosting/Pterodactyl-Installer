...
GITHUB_BASE_URL="https://raw.githubusercontent.com/Hexel-Hosting/pterodactyl-installer"
...
output "di Recode oleh @Hexel-Hosting (Hexel-HOST)""
output
...
output
output "Made with ❤️ by @Hexel-Hosting (Hexel-HOST)""
output "https://github.com/Hexel-Hosting/pterodactyl-installer"
output
output
