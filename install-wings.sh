...
main() {
  ...
  echo "* di Recode oleh @Hexel-Hosting (Hexel-HOST)"
  echo "*"
  echo "* Jika ingin menggunakan script resmi, silahkan kunjungi:"
  echo "* https://github.com/vilhelmprytz/pterodactyl-installer"
  echo "*"
  echo "* Made with ❤️ by @Hexel-Hosting (Hexel-HOST)"
  echo "* https://github.com/Hexel-Hosting/pterodactyl-installer"
  echo "*"
...
function goodbye {
  ...
  echo "* "
  echo "* Made with ❤️ by @Hexel-Hosting (Hexel-HOST)""
  echo "* https://github.com/Hexel-Host/pterodactyl-installer"
  echo "* "
